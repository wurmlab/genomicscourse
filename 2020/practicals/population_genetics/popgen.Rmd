...
```{r}
## PCA
# Run PCA - scale = TRUE meaning any outliers will be accounted for, reccomended if no prewious normalisation was applied to the data
...
pca_plot <- pca_results_invert %>% 
  ...
  coord_fixed(ratio = 1) +
  theme(
    axis.title.x = element_text(colour = "gray20", size = 12),
...
ggplot(data = data.frame(1:length(win_fst), win_fst)) + 
  geom_point(aes(x  = X1.length.win_fst., y = win_fst)) + 
  xlab(paste0("window")) +
  ylab(paste0("measurements per window")) +
  theme(
    axis.title.x = element_text(colour = "gray20", size = 12),
    axis.title.y = element_text(colour = "gray20", size = 12),
    axis.text.x = element_text(colour = "gray20", size = 10),
...
ggplot(data = data.frame(1:length(bb_div), bb_div)) + 
  geom_point(aes(x  = X1.length.bb_div., y = bb_div)) + 
  xlab(paste0("window")) +
  ylab(paste0("diversity among B")) +
  theme(
    axis.title.x = element_text(colour = "gray20", size = 12),
    axis.title.y = element_text(colour = "gray20", size = 12),
    axis.text.x = element_text(colour = "gray20", size = 10),
...
ggplot(data = data.frame(1:length(lb_div), lb_div)) + 
  geom_point(aes(x  = X1.length.lb_div., y = lb_div)) + 
  xlab(paste0("window")) +
  ylab(paste0("diversity among b")) +
  theme(
    axis.title.x = element_text(colour = "gray20", size = 12),
