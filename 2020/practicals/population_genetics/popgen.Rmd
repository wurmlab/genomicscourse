...
```{r}
# Load libraries
if(!require("ggplot2", "tidyverse", "adegenet", "PopGenome")){
    install.packages("ggplot2", "tidyverse", "adegenet", "PopGenome")
    library(ggplot2, tidyverse, tibble, dplyr, adegenet, PopGenome)
}
if(!require("dplyr")){
