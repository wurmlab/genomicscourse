...
To run BLAST you require an appropriate algorithm, query sequence and a reference database. Your input query sequences are these generated by MAKER during previous steps.
You have uniref50 database available in your `~/2019-09-BIO271_input` directory. This would be used as a reference database for your BLAST. BLAST can produce outputs in different formats, including HTML format, which may be more amenable for inspection.
