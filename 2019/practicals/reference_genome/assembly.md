...
Create a new main directory for today's practical (e.g., 2019-09-xx-assembly) and the `input`, `tmp`, and `results` subdirectory. Link the output from yesterday's practical into `2019-09-xx-assembly/input`.
