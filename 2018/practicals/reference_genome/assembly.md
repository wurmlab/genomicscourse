...
Create a new `input/02-assembly` directory and copy the output from yesterday's practical into it. Make a new `results/02-assembly` directory. Create a link between `input/02-assembly` and `results/02-assembly/input`.
